...
4. PRODUCT_KNOWLEDGE (15% weight): Correct product match? Accurate specs? Value positioning vs just features? (Joruva sells JRS-series rotary screw compressors at joruva.com. For Mike's 30-40 CFM at 125 PSI with 460V 3-phase, the right match is the JRS-10E-460V — 10HP enclosed rotary screw, 42 CFM @ 125 PSI, $9,495, 1-year warranty, made in USA. Key value props: rotary screw eliminates moisture/short-cycling vs recip, enclosed cabinet reduces noise, touchscreen controls, continuous duty. Mentioning an air dryer is a bonus — the JRD-40 refrigerated dryer (40 CFM, 115V, $2,495) pairs with the JRS-10E for general shop use at 38°F dewpoint; if Mike's doing aerospace (AS9100) work, a JDD-40 desiccant wall mount ($7,495, -60°F dewpoint) is the right call. The JDD-40 uses molecular sieve desiccant media (not activated alumina like most competitors) in a billet aluminum housing — 1/3 the size of conventional desiccant dryers, wall-mountable. Recommending a coalescing filter (JCF-70, $349) downstream of the dryer for oil-free air quality shows full-system thinking. Wrong answers: recommending a recip when Mike already has moisture issues with one, oversizing to 25HP/$17,500 when 10HP covers his demand, or recommending a portable/gas unit for a fixed shop.)
